...
class UpdateCustomerService {
  static Future<String> UpdateCustomer(body) async {
    print(body);

    Map<String, String> requestHeaders = {'Content-Type': 'application/json'};

    final response = await http.post(Uri.parse('${URLS.BASE_URL}/customer/updatecustomer'), body: jsonEncode(body), headers: requestHeaders);
