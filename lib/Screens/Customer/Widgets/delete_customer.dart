...
class _DeleteCustomerState extends State<DeleteCustomer> {
  ...
  Future<void> startDeleteJCustomer() async {
    ...
    final body = {"_id": customerModel.cusid};

    print(body);

    Map<String, String> requestHeaders = {'Content-Type': 'application/json'};

    final response = await http.post(Uri.parse('${URLS.BASE_URL}/customer/removeCustomer'), body: jsonEncode(body), headers: requestHeaders);
