  ...
  Widget _bodyContent(BuildContext contect) {
    ...
    return SingleChildScrollView(
      child: isfetching
          ...
          : isEmpty
              ? const Text("No jobs for this vehicle")
              : Column(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        SizedBox(
                                            ...
                                            child: Text(
                                              "Job Assigned ${timeAgo.format(date)}",
                                              style: TextStyle(
                                            ...
                                            decoration: BoxDecoration(
                                                image: DecorationImage(
                                                    image: status == "onGoing"
                                                        ? const AssetImage('assets/images/inprogress.png')
                                                        : const AssetImage('assets/images/completed2.png'),
                                                    fit: BoxFit.fill))),
                                      ],
                                    ),
                                  ],
