...
//       final colorTween = ColorTween(begin: widget.progressColor, end: widget.changeProgressColor);
//       progressColor = colorTween.transform(transformValue(animation.value, widget.changeColorValue, widget.maxValue, 5));
//     }
...
//           child: Text((animation.value * widget.maxValue).toInt().toString() + widget.displayText,
//               softWrap: false, style: const TextStyle(color: Color(0xFFFFFFFF), fontSize: 8)));
...
//           children: <Widget>[
//             Expanded(flex: (animation.value * 100).toInt(), child: Stack(children: progressWidgets)),
//             Expanded(flex: 100 - (animation.value * 100).toInt(), child: Container())
//           ],
//         ),
//       ),
//     );
